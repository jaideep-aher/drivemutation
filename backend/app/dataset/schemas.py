...
class CompositionKey(StrictModel):
    """Unique scenario composition used for leakage-safe splits."""
...
class RejectionTarget(StrictModel):
    """Structured rejection for impossible / contradictory requests."""
...
class MutationTarget(StrictModel):
    """Accepted canonical mutation target."""
...
class DatasetExample(StrictModel):
    """Full supervised example with metadata + OpenAI SFT messages."""
